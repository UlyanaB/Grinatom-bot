<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsersAndLogsForm.aspx.cs" Inherits="WebAdmin.WebForms.UsersAndLogsForm" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="id" DataSourceID="SqlDataSourceUsers" ForeColor="#333333" GridLines="None" OnSelectedIndexChanging="GridView1_SelectedIndexChanging">
            ...
            <asp:SqlDataSource ID="SqlDataSourceUsers" runat="server" ConnectionString="<%$ ConnectionStrings:TelegramBotConnectionString %>" SelectCommand="SELECT * FROM [BotUsers] ORDER BY [tlgUserName]"></asp:SqlDataSource>
        </div>
